...
#pragma config(Motor,  port2,           wheelR,        tmotorVex269, openLoop)
#pragma config(Motor,  port3,           liftL,         tmotorVex269, openLoop)
#pragma config(Motor,  port4,           liftR,         tmotorVex269, openLoop)
#pragma config(Motor,  port5,           wheelL,        tmotorVex269, openLoop)
...
void rotate(int check1){
	...
	if (check1 < 0){
		...
		while (time1[T1] < check1){
			motor[wheelL] = wheel_setting;
			motor[wheelR] = -wheel_setting;
		}
		motor[wheelR] = 0;
		motor[wheelL] = 0;
  }
